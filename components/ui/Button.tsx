...
const buttonVariants = cva(
  "relative inline-block px-7 py-3 text-lg font-semibold text-[#422800] bg-[#F2DA10] rounded-[12px] hover:bg-gray-800 hover:text-[#F2DA10] ",
  {
    variants: {
      variant: {
        primary:
          "border-2 border-[#422800] shadow-[2px_2px_0_0_#000000] transition-all duration-200 ease-out hover:bg-white active:shadow-[2px_2px_0_0_#422800] active:translate-x-[2px] active:translate-y-[2px] md:min-w- md:px-10",
        secondary:
